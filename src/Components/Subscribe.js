...
function Subscribe() {
    ...
    const clickHandle=(e)=>{
        e.preventDefault();
        axios.post('http://localhost/project9/PHP/userInfo.php?city='+city+'&address='+address+'&zip_code='+zip_code+'&phone_number='+phone_number+'&message='+message+'&gender='+gender+'&weight='+weight+'&height='+height+'&age='+age+'&id=24&calories='+calories+'&package_type'+package_type).then(()=>{
            console.log("success!");
